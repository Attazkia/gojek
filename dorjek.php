...
// function change(){
        ...
        otp:
        echo color("green","💬▶️ MASUKKAN OTPNYA : ");
       ...
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD2107"}');
        ...
        echo "\n".color("yellow","# CLAIM VOUCHER IIII");
        echo "\n".color("white","# PLEASE WAIT");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        ...
        $TOKEN  = "1032900146:AAE7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("red","!] Coba Nomer yang lain \n");
         goto ulang;
         }
//  }
